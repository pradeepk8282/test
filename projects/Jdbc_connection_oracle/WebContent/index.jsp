...
<body bgcolor="orange">
 ...
 <sql:update dataSource="${snapshop}" var="result">INSERT INTO EMP (EMPNO,ENAME,SAL) VALUES (15,'PhfdER',500)
	</sql:update> 

	<%-- <sql:query var="result" dataSource="${snapshot}">SELECT * FROM EMPLOYEE</sql:query> --%>
